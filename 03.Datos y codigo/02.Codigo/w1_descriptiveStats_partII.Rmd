...
```{r , echo=TRUE}
n <- nrow(CigarettesB) # La función nrow identifica el número de filas de un dataframe o matriz. En este caso el número de filas corresponde al número de observacines.

CigarettesB$pack[order(CigarettesB$pack,decreasing = TRUE)]

print(n) # 46 es par, por lo que la media será el promedio de los dos datos que ocupan la posición central
